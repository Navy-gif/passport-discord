...
function Strategy(options, verify) {
    ...
    options.authorizationURL = options.authorizationURL || `https://discord.com/api${version}/oauth2/authorize`;
    options.tokenURL = options.tokenURL || `https://discord.com/api${version}/oauth2/token`;
...
Strategy.prototype.userProfile = function(accessToken, done) {
    var self = this;
    this._oauth2.get(`https://discord.com/api${this.version}/users/@me`, accessToken, function(err, body, res) {
        if (err) {
...
Strategy.prototype.checkScope = function (scope, accessToken, cb) {
    if (this._scope && this._scope.indexOf(scope) !== -1) {
        this._oauth2.get(`https://discord.com/api${this.version}/users/@me/` + scope, accessToken, function(err, body, res) {
